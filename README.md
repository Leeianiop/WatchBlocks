...
PCB file has 2 pcb inside for the top (left) and bottom layer (right).  PCB also has 4 layers, below are all of them separately   
PCB "+" Sign also indicates the way you should place the PCB, so make sure bot "+" of your PCB are facing the same direction
